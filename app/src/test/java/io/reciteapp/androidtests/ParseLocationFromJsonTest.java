...
import static io.reciteapp.androidtests.FileReaderUtil.readFile;
import static io.reciteapp.androidtests.JsonParser.parseLocationFromJson;
...
public class ParseLocationFromJsonTest {
  ...
  public void parseLocationFromJson_NotAJsonInput_EmptyLocation() {
    Location location = parseLocationFromJson("Some words that keep my feeling hurts");
    assertThatLocationIsEmpty(location);
  }
